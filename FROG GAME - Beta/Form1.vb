Public Class Form1
    ...
    Private Sub picCar_Click(sender As Object, e As EventArgs) Handles picCar1.Click, picCar5.Click, picCar4.Click, picCar3.Click, picCar2.Click, picCar6.Click, picCar9.Click, picCar8.Click, picCar7.Click, picCar10.Click, PictureBox1.Click, picCar11.Click
...
picFrog.Top <= picLag12.Top + picLag12.Height Then
    ...
    Private Sub TurtleGrp1_Tick(sender As Object, e As EventArgs) Handles TurtleGrp1.Tick
        ...
        'Turtle sink
        If intrv1 = 1 Then
            picTurtle1.Image = My.Resources.TurtleRightSink
            t1 = False
        ElseIf intrv1 = 2 Then
            picTurtle2.Image = My.Resources.TurtleRightSink
            t2 = False
        ElseIf intrv1 = 3 Then
            picTurtle3.Image = My.Resources.TurtleRightSink
            t3 = False
        ElseIf intrv1 = 4 Then
            picTurtle4.Image = My.Resources.TurtleRightSink
            t4 = False

            'Turtle float
        ElseIf intrv1 = 25 Then
            picTurtle1.Image = My.Resources.TurtleRightDefault
            t1 = True
        ElseIf intrv1 = 26 Then
            picTurtle2.Image = My.Resources.TurtleRightDefault
            t2 = True
        ElseIf intrv1 = 27 Then
            picTurtle3.Image = My.Resources.TurtleRightDefault
            t3 = True
        ElseIf intrv1 = 28 Then
            picTurtle4.Image = My.Resources.TurtleRightDefault
            t4 = True
    ...
    Private Sub TurtleGrp2_Tick(sender As Object, e As EventArgs) Handles TurtleGrp2.Tick
        ...
        'Turtle sink
        If intrv2 = 1 Then
            picTurtle5.Image = My.Resources.TurtleLeftSink
            t5 = False
        ElseIf intrv2 = 2 Then
            picTurtle6.Image = My.Resources.TurtleLeftSink
            t6 = False
        ElseIf intrv2 = 3 Then
            picTurtle7.Image = My.Resources.TurtleLeftSink
            t7 = False
        ElseIf intrv2 = 4 Then
            picTurtle8.Image = My.Resources.TurtleLeftSink
            t8 = False

            'Turtle float
        ElseIf intrv2 = 25 Then
            picTurtle5.Image = My.Resources.TurtleLeftDefault
            t5 = True
        ElseIf intrv2 = 26 Then
            picTurtle6.Image = My.Resources.TurtleLeftDefault
            t6 = True
        ElseIf intrv2 = 27 Then
            picTurtle7.Image = My.Resources.TurtleLeftDefault
            t7 = True
        ElseIf intrv2 = 28 Then
            picTurtle8.Image = My.Resources.TurtleLeftDefault
            t8 = True
    ...
    Private Sub TurtleGrp3_Tick(sender As Object, e As EventArgs) Handles TurtleGrp3.Tick
        ...
        'Turtle sink
        If intrv3 = 1 Then
            picTurtle9.Image = My.Resources.TurtleRightSink
            t9 = False
        ElseIf intrv3 = 2 Then
            picTurtle10.Image = My.Resources.TurtleRightSink
            t10 = False
        ElseIf intrv3 = 3 Then
            picTurtle11.Image = My.Resources.TurtleRightSink
            t11 = False

            'Turtle float
        ElseIf intrv3 = 25 Then
            picTurtle9.Image = My.Resources.TurtleRightDefault
            t9 = True
        ElseIf intrv3 = 26 Then
            picTurtle10.Image = My.Resources.TurtleRightDefault
            t10 = True
        ElseIf intrv3 = 27 Then
            picTurtle11.Image = My.Resources.TurtleRightDefault
            t11 = True
    ...
    Private Sub TurtleGrp4_Tick(sender As Object, e As EventArgs) Handles TurtleGrp4.Tick
        ...
        'Turtle sink
        If intrv4 = 1 Then
            picTurtle12.Image = My.Resources.TurtleRightSink
            t12 = False
        ElseIf intrv4 = 2 Then
            picTurtle13.Image = My.Resources.TurtleRightSink
            t13 = False
        ElseIf intrv4 = 3 Then
            picTurtle14.Image = My.Resources.TurtleRightSink
            t14 = False

            'Turtle float
        ElseIf intrv4 = 25 Then
            picTurtle12.Image = My.Resources.TurtleRightDefault
            t12 = True
        ElseIf intrv4 = 26 Then
            picTurtle13.Image = My.Resources.TurtleRightDefault
            t13 = True
        ElseIf intrv4 = 27 Then
            picTurtle14.Image = My.Resources.TurtleRightDefault
            t13 = True
    ...
    Private Sub TurtleGrp5_Tick(sender As Object, e As EventArgs) Handles TurtleGrp5.Tick
        ...
        'Turtle sink
        If intrv5 = 1 Then
            picTurtle15.Image = My.Resources.TurtleRightSink
            t15 = False
        ElseIf intrv5 = 2 Then
            picTurtle16.Image = My.Resources.TurtleRightSink
            t16 = False
        ElseIf intrv5 = 3 Then
            picTurtle17.Image = My.Resources.TurtleRightSink
            t17 = False

            'Turtle float
        ElseIf intrv5 = 25 Then
            picTurtle15.Image = My.Resources.TurtleRightDefault
            t15 = True
        ElseIf intrv5 = 26 Then
            picTurtle16.Image = My.Resources.TurtleRightDefault
            t16 = True
        ElseIf intrv5 = 27 Then
            picTurtle17.Image = My.Resources.TurtleRightDefault
            t17 = True
    ...
    End Sub
    Private Sub Car_MoveLeft_Loop(sender As Object, e As EventArgs) Handles picCar1.Move, picCar5.Move, picCar4.Move, picCar3.Move, picCar2.Move, picCar10.Move, PictureBox1.Move, picCar11.Move
        If sender.left + sender.width <= 0 Then
