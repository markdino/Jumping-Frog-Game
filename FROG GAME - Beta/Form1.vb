Public Class Form1
    ...
    Private Sub picCar_Click(sender As Object, e As EventArgs) Handles picCar1.Click, picCar5.Click, picCar4.Click, picCar3.Click, picCar2.Click, picCar6.Click
...
picFrog.Top <= picLag12.Top + picLag12.Height Then
    ...
    Private Sub Car_MoveLeft_Loop(sender As Object, e As EventArgs) Handles picCar1.Move, picCar5.Move, picCar4.Move, picCar3.Move, picCar2.Move
        ...
        End If
    End Sub
    Private Sub Car_MoveRight_Loop(sender As Object, e As EventArgs) Handles picCar6.Move
        If sender.left > picRiver.Width Then
            sender.left = 0 - sender.Width
        End If
    End Sub
